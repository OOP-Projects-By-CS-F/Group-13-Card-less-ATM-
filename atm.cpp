...
public:                                                 //declaring all the variables 
    ...
    string str2 = "1234";       //<-account no. of users
    string str3 = "12345";      //<-
    string str4 = "12346";      //<-
    ...
    void check()                                            //checking which of the user is trying to login //
    {
       ...
       string str2 = "1234";                           // and storing its value inrespective variables             
        ...
        // else
        // cout << "NO USER FOUND WITH THE ACCOUNT NUMBER YOU HAVE ENTERD"<<endl;
    }
    ...
    int cashWithDraw()              // to withwdraw the balance from the account
